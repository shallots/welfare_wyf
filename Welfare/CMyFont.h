...
class CMyFont : public COleDispatchDriver
{
public:
	CMyFont(){} // 调用 COleDispatchDriver 默认构造函数
	CMyFont(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMyFont(const CMyFont& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
