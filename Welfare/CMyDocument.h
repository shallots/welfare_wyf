...
class CMyDocument : public COleDispatchDriver
{
public:
	CMyDocument(){} // 调用 COleDispatchDriver 默认构造函数
	CMyDocument(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CMyDocument(const CMyDocument& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
